				...
				<View style={{ height: "50%", marginTop: 16, zIndex: 1 }}>
					<>
						<TextInput
							...
							autoFocus
						/>
						<Paragraph style={{ color: isCorrect ? "green" : "#fff" }}>
